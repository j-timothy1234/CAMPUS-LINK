        ...
        <div class="row mb-4">
          <div class="col-12">
            <div class="card shadow-sm">
              ...
              <div class="card-body">
                <p>Hello, <strong><?php echo $username; ?></strong>! This is your driver dashboard. Use the sidebar menu to navigate between different sections:</p>
                <ul class="list-group list-group-flush">
                  <li class="list-group-item"><strong>📍 Maps</strong> - View live location and active rides</li>
                  <li class="list-group-item"><strong>🚗 Trips</strong> - Check your trip history</li>
                  <li class="list-group-item"><strong>🔔 Notifications</strong> - View incoming ride requests</li>
