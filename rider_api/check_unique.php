...
if ($plate) { $clauses[] = 'Motorcycle_Plate_Number=?'; $types .= 's'; $values[] = $plate; }

$sql = 'SELECT Username, Email, Phone_Number, Motorcycle_Plate_Number FROM riders WHERE ' . implode(' OR ', $clauses) . ' LIMIT 1';
...
if ($res && $res->num_rows > 0) {
    ...
    if ($plate && $row['Motorcycle_Plate_Number'] === $plate) $matched[] = 'plate';
