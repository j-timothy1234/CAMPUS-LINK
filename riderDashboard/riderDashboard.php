...
if (!isset($_SESSION['loggedin']) || $_SESSION['user_type'] !== 'rider') {
    header("Location: ../riders/rider_login.html"); // Adjust if needed
    exit();
}
  ...
  <main class="flex-grow-1">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm px-3">
      ...
      <header class="driver-header text-center py-4">
        <!-- Dynamic welcome message with rider's name from session -->
      ...
      <div class="row mb-4">
        ...
        <div class="col-12 col-md-4 mb-4">
          <div class="card text-center shadow-sm display-card">
            ...
            <div class="card-body">
              <p class="card-text text-white fw-semibold">Profile Picture</p>
              <!-- Display driver ID from session -->
              <p class="card-text text-white">RIDER ID: <?php echo $rider_id; ?></p>
            </div>
          </div>
        </div>
...
<script src="riderDashboard.js"></script>
<script src="ridersDashboard.js"></script>
</body>
</html>